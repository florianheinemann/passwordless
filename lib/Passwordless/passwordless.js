 ...
 * is used without flash middleware or allowPost is used without body parser middleware
 */
 ...
 * @return {function(req, res, next)} Express middleware
 * @throws {Error} Will throw an error if failureFlash is used without flash middleware, 
 * failureFlash is used without failureRedirect, no body parser is used and POST
 * parameters are expected, or if no delivery method has been added
 */
