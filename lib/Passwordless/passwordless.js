 ...
 * to the supplied URL in case of a successful authentication. This option is over-
 * written by option.enableOriginRedirect if set and an origin has been supplied. 
 * It is strongly recommended to set this option to avoid leaking valid tokens
 * via the HTTP referrer. In case of session-less operation, though, you might 
 * want to ignore this flag for efficient operation (default: null)
